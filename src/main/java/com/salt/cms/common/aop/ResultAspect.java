package com.salt.cms.common.aop;

import com.salt.cms.vo.UnifyResponseVO;
import com.salt.cms.common.configuration.CodeMessageConfiguration;
...
public class ResultAspect {
    @AfterReturning(returning = "result", pointcut = "execution(public * com.salt.cms.controller..*.*(..))")
